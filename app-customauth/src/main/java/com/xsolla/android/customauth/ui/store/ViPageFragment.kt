...
import com.xsolla.android.customauth.databinding.FragmentViPageBinding
...
class ViPageFragment : BaseFragment(), PurchaseListener {
    ...
    private val binding: FragmentViPageBinding by viewBinding()
    private val vmCart: VmCart by activityViewModels()
    private val vmBalance: VmBalance by activityViewModels()

    override fun getLayout() = R.layout.fragment_vi_page
